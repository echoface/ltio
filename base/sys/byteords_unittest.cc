...
#ifndef EXPECT_EQ
#define EXPECT_EQ(l, r) CATCH_REQUIRE((l) == (r))
#endif
...
CATCH_TEST_CASE("byteorder.swap16", "[byteorder swap16 test]") {
  uint16_t swapped = base::ByteSwap(k16BitTestData);
  CATCH_REQUIRE(k16BitSwappedTestData == swapped);
  uint16_t reswapped = base::ByteSwap(swapped);
  CATCH_REQUIRE(k16BitTestData == reswapped);
}

CATCH_TEST_CASE("byteorder.swap32", "[byteorder swap32 test]") {
...
CATCH_TEST_CASE("byteorder.swap64", "[byteorder swap64 test]") {
...
CATCH_TEST_CASE("byteorder.uintptr", "[byteorder uintptr test]") {
...
CATCH_TEST_CASE("byteorder.tole16", "[byteorder tole16 test]") {
...
CATCH_TEST_CASE("byteorder.tole32", "[byteorder tole32 test]") {
...
CATCH_TEST_CASE("byteorder.tole64", "[byteorder tole64 test]") {
...
CATCH_TEST_CASE("byteorder.tohost16", "[byteorder tohost16 test]") {
...
CATCH_TEST_CASE("byteorder.tohost32", "[byteorder tohost32 test]") {
...
CATCH_TEST_CASE("byteorder.tohost64", "[byteorder tohost64 test]") {
...
CATCH_TEST_CASE("byteorder.tonet16", "[byteorder tonet16 test]") {
...
CATCH_TEST_CASE("byteorder.tonet32", "[byteorder tonet32 test]") {
...
CATCH_TEST_CASE("byteorder.tonet64", "[byteorder tonet64 test]") {
